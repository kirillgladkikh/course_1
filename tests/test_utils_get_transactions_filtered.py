...
def test_get_transactions_filtered_default_date() -> None:
...
def test_get_transactions_filtered_string_date() -> None:
...
def test_get_transactions_filtered_empty_list() -> None:
...
# ==========================================
def test_get_transactions_filtered_single_transaction() -> None:
...
def test_get_transactions_filtered_no_matching_transactions() -> None:
...
def test_get_transactions_filtered_exact_target_date() -> None:
    # Тест с точной датой
...
def test_get_transactions_filtered_early_target_date() -> None:
    # Тест с ранней датой
    target_date = Timestamp('2021-12-10 00:00:00')
    result = get_transactions_filtered(test_transactions, target_date)
    assert len(result) == 0  # Нет транзакций до 10 декабря

def test_get_transactions_filtered_missing_transaction_date() -> None:
...
def test_get_transactions_filtered_invalid_timestamp() -> None:
...
def test_get_transactions_filtered_different_time() -> None:
